        ...
        $(function(){
            ...
            function showData(){
                $('.datatable-colvis-basic').DataTable({
                    ...
                    autoWidth: true,
                    destroy: true,
                    ajax: "{{URL::to('home/data/diagnosa')}}",
                    columns: [
                        {data: 'no', name: 'no',title:'No.',searchable:false,width:'5%'},
                        {data: 'kode_icd', name: 'kode_icd',title:'Kode ICD',width:'20%'},
                        {data: 'diagnosa', name: 'diagnosa',title:'Diagnosa'},
                            ...
                            '<div class="modal-content">'+
                                ...
                                '<div class="modal-body">'+
                                    ...
                                    '<div class="form-group">'+
                                        '<label class="control-label text-semibold">Kode ICD</label>'+
                                        '<input class="form-control" name="kode" id="kode" placeholder="Kode ICD" required>'+
                                    '</div>'+
                                    '<div class="form-group">'+
            ...
            $(document).on("click",".edit",function(){
                ...
                $.ajax({
                    url:"{{URL::to('home/data/diagnosa')}}/"+kode,
                    type:"GET",
                    beforeSend:function(){
                        el+='<div id="modal_default" class="modal fade" data-backdrop="static" data-keyboard="false">'+
                            '<div class="modal-dialog">'+
                    ...
                    success:function(result){
                        el+='<div id="pesan"></div>'+
                            '<div class="form-group">'+
                                '<label class="control-label text-semibold">Kode ICD</label>'+
                                '<input class="form-control" name="kode" value="'+result.kode_icd+'" id="kode" placeholder="Kode ICD" required>'+
                            '</div>'+
                            '<div class="form-group">'+
                                '<label class="control-label text-semibold">Name</label>'+
                                '<input class="form-control" name="name" value="'+result.diagnosa+'" id="name" placeholder="Name" required>'+
                            '</div>';
